...
/**
 * フレームワーク標準のProgressViewを提供する。
 * フルスクリーンであり、タップガードを行う。
 */
public class SupportProgressView extends FrameLayout {
    ...
    public SupportProgressView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public SupportProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
