...
public class SnackbarBuilder {
    ...
    public SnackbarBuilder show() {
        ...
        snackbarView.setBackground(new ColorDrawable(ContextCompat.getColor(mContainer.getContext(), R.color.EsMaterial_Grey_50)));
        ((TextView) snackbarView.findViewById(R.id.snackbar_text)).setTextColor(ContextCompat.getColor(mContainer.getContext(), R.color.EsMaterial_Grey_800));
        if (mAction != null) {
