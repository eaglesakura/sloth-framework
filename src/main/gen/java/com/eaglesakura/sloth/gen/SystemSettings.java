...
public class SystemSettings extends com.eaglesakura.sloth.db.property.internal.GeneratedProperties {
    ...
    public SystemSettings(com.eaglesakura.sloth.db.property.PropertyStore store){ setPropertyStore(store); }
